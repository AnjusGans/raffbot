...
*Official Bot By @${numbernye.split("@")[0]} , @${ow.split("@")[0]}*
*Powered By @${numbernye.split("@")[0]}*`}
...
exports.gachamenu = (prefix, dev, numbernye) => { 
return `*╭─❲ NFSW MENU ❳*
${bi}${prefix}cecan
${bi}${prefix}cogan
${bi}${prefix}husbu
...
exports.gcofficial = (player, hahh) => { 
	return `Silahkan join Group ,sekedar senang-senang dan mengetahui Update terbaru Dari Bot
