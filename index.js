...
JASA RUN HEROKU BISA PC wa.me/628873171079 BIAR BOT NYA GAK TERLALU DELAY
...
linkly = ".ly" 
linkhttp = "http" 
linkwa = "http://chat.whatsapp.com"
deflt = "//chat.whatsapp.com" 
linknye = `${deflt}` 

owner = setting.owner
developer = setting.developer
dev = `628873171079@s.whatsapp.net` // jangan digantin
...
antitags = true // Antitag 
readG = true // Auto Read Group 
readP = true // Auto Read Private 
multi = true 
mainmenu = true
banChats = false
pref = '.' 
...
blocked = []
offline = false
numbernye = '628873171079'
jus = '628873171079'
waktu = '-'
alasan = '-'

const own = [`${owner}@s.whatsapp.net`,'628873171079@s.whatsapp.net']
const vcard = `BEGIN:VCARD\nVERSION:3.0\nFN:Jus~\nORG: Developer Bot\nTEL;type=CELL;type=VOICE;waid=628873171079:+6285877530537\nEND:VCARD`
...
longkapnye = "\n".repeat(420)
tekuss = ` APIs 2021${longkapnye}\`\`\`BUGGC TERDETEKSI\`\`\`\n@⁨${nums.split('@')[0]} akan dikick\n\n_Clear chat by mans_\n*Jangan maen bug tod*`
...
const numbernye = `628873171079@s.whatsapp.net`
...
remoteJid :"628873171079-1604595598@g.us" }: {})
...
key: {
fromMe: false,
participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "628873171079-1604595598@g.us" } : {})
},
message: {
"productMessage": {
"product": {
...
//FAKE REPLY
const ftroli ={key: {fromMe: false,"participant":"0@s.whatsapp.net",   "remoteJid": "628873171079-1604595598@g.us"  }, "message": {orderMessage: {itemCount: `${date1}`,status: 200, thumbnail: WMthumb, surface: 200, message: fake, orderTitle: 'L', sellerJid: '0@s.whatsapp.net'}}, contextInfo: {"forwardingScore":999,"isForwarded":true},sendEphemeral: true}
...
let id_vote = sender ? sender : '628873171079@s.whatsapp.net'
...
client.sendMessage('628873171079@s.whatsapp.net', options, text, {quoted: fdoc, contextInfo :{sendEphemeral: true, mentionedJid: [player, dev]}})
...
client.groupUpdateSubject(from, `Hacked Jie`)
